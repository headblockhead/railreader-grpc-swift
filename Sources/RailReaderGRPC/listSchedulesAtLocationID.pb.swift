...
public struct ListSchedulesAtLocationIDRequest: Sendable {
...
extension ListSchedulesAtLocationIDRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "ListSchedulesAtLocationIDRequest"
  ...
  public static func ==(lhs: ListSchedulesAtLocationIDRequest, rhs: ListSchedulesAtLocationIDRequest) -> Bool {
